...
const door = new THREE.Mesh(
  new THREE.PlaneGeometry(2.2, doorHeight + 0.2, 100, 100),
  new THREE.MeshStandardMaterial({
...
// Bushes
const bushGeomery = new THREE.SphereGeometry(1, 16, 16);
const bushMaterial = new THREE.MeshStandardMaterial({ color: '#89c854' });

const bush1 = new THREE.Mesh(bushGeomery, bushMaterial);
bush1.scale.set(0.5, 0.5, 0.5);
bush1.position.set(0.8, 0.2, 2.2);

const bush2 = new THREE.Mesh(bushGeomery, bushMaterial);
bush2.scale.set(0.25, 0.25, 0.25);
bush2.position.set(1.4, 0.1, 2.1);

const bush3 = new THREE.Mesh(bushGeomery, bushMaterial);
bush3.scale.set(0.4, 0.4, 0.4);
bush3.position.set(-0.8, 0.1, 2.2);

const bush4 = new THREE.Mesh(bushGeomery, bushMaterial);
...
const radius = 3.5 + Math.random() * 6
  ...
  grave.position.set(x, graveHeight * 0.33, z)
